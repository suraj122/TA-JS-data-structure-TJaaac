...
let movieActor = movies[0].actors;
for (let actor of movieActor) {
  console.log(actor);
}
...
let firstMovieGenere = movies[0].genres;
for (let genere of firstMovieGenere) {
  console.log(genere);
}
// 19. Log all the genres of the second movie one by one
let secondMovieGenere = movies[1].genres;
for (let genere of secondMovieGenere) {
  console.log(genere);
}
