...
console.log(
  `I am ${got.houses[0].people[2].name} and my bio is ${got.houses[0].people[2].description}`
);

// 10. Log the name and description of the people in house Lannisters whose name is `Tywin Lannister`
console.log(
  `I am ${got.houses[1].people[0].name} and my bio is ${got.houses[1].people[0].description}`
);
